  ...
  sections: [
    { id: 'session', title: 'First access, session and display preferences', topics: [
      ...
      { id: 'display', title: 'Language, theme, dates and navigation', paragraphs: [
        ...
        'On narrow screens, open Menu to navigate. Keyboard users can use the skip link to reach the main content. Lists and selectors have separate Previous and Next controls; an empty first page or an unselected tenant is not evidence that no resource exists. The Connectors list has a text filter. Guided onboarding also provides searchable choices for Tenant, Application, Environment, Installation ID, Connector and version. Type in a choice to narrow its results, then select the intended record. Where an unsaved-changes dialog appears, Stay preserves the current edit and Discard leaves it. Cancel closes a form without saving; do not rely on every screen or sign-out action to preserve unsaved work.'
      ] }
    ] },
